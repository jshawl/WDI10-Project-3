...
class EncountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encounter" do
    assert_difference('Encounter.count') do
      post encounters_url, params: { encounter: { [site: @encounter.[site, comments: @encounter.comments, site_id: @encounter.site_id } }
    end
  ...
  test "should update encounter" do
    patch encounter_url(@encounter), params: { encounter: { [site: @encounter.[site, comments: @encounter.comments, site_id: @encounter.site_id } }
